...
data=spark.read.csv("cleanData3.csv",header=True)
...
table1.coalesce(1).write.option("header", "true").csv("table1.csv")

yyy20.coalesce(1).write.option("header", "true").csv("yyy20.csv")
yyy21.coalesce(1).write.option("header", "true").csv("yyy21.csv")
yyy22.coalesce(1).write.option("header", "true").csv("yyy22.csv")
yyy23.coalesce(1).write.option("header", "true").csv("yyy23.csv")
yyy24.coalesce(1).write.option("header", "true").csv("yyy24.csv")
yyy25.coalesce(1).write.option("header", "true").csv("yyy25.csv")
yyy26.coalesce(1).write.option("header", "true").csv("yyy26.csv")
yyy27.coalesce(1).write.option("header", "true").csv("yyy27.csv")
yyy28.coalesce(1).write.option("header", "true").csv("yyy28.csv")
yyy29.coalesce(1).write.option("header", "true").csv("yyy29.csv")
yyy2.coalesce(1).write.option("header", "true").csv("yyy2.csv")
yyy2.coalesce(1).write.option("header", "true").csv("yyy2.csv")

hfs -getmerge yyy20.csv yyy20.csv
hfs -getmerge yyy21.csv yyy21.csv
hfs -getmerge yyy22.csv yyy22.csv
hfs -getmerge yyy23.csv yyy23.csv
hfs -getmerge yyy24.csv yyy24.csv
hfs -getmerge yyy25.csv yyy25.csv
hfs -getmerge yyy26.csv yyy26.csv
hfs -getmerge yyy27.csv yyy27.csv
hfs -getmerge yyy28.csv yyy28.csv
hfs -getmerge yyy29.csv yyy29.csv
hfs -getmerge ddd3.csv ddd3.csv
hfs -getmerge ddd4.csv ddd4.csv
hfs -getmerge ddd5.csv ddd5.csv
